        ...
        <AnimatePresence>
          {displayedMembers.map((member) => (
            <motion.div
              ...
              exit="exit"
              layout
              className="bg-white dark:bg-gray-800 rounded-[45px] border border-gray-200 dark:border-gray-700 p-6 cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-[1.02] group"
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <motion.div
                  ...
                  className="w-8 h-8 bg-gray-900 dark:bg-white rounded-full flex items-center justify-center transition-transform duration-200"
                >
